    ...
    <div className="mr-1 max-w-[280px] min-w-[220px] bg-slate-300 h-full rounded-lg border overflow-y-scroll no-scrollbar">
      <div className="flex flex-col justify-between h-[calc(100%-0px)] bg-blue-50">
        <div className="px-1 py-2">
          <span className="block w-full h-10 bg-gray-200 rounded-lg"></span>

          <nav aria-label="Main Nav" className="flex flex-col mt-5 space-y-1">
            <a
              href="#"
              className="flex items-center px-4 py-2 text-black bg-gray-100 rounded-lg border mb-1"
            >
              <svg
            ...
            <details className="group [&_summary::-webkit-details-marker]:hidden">
              <summary className="flex items-center px-4 py-2 text-gray-500 rounded-lg cursor-pointer hover:bg-orange-300 border hover:text-black">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-5 h-5 opacity-75"
                  fill="none"
              ...
              <nav aria-label="Teams Nav" className="mt-1.5 ml-8 flex flex-col">
                <a
                  href="#"
                  className="flex items-center px-4 py-2 text-gray-500 rounded-lg hover:bg-orange-300 border hover:text-black"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-5 h-5 opacity-75"
            ...
            <details className="group [&_summary::-webkit-details-marker]:hidden">
              ...
              >
                ...
                <form action="/logout">
                  <button
                    type="submit"
                    className="flex items-center w-full px-4 py-2 text-gray-500 rounded-lg hover:bg-orange-300 border hover:text-black"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="w-5 h-5 opacity-75"
