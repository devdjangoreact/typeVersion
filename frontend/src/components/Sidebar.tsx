      ...
      <div className="flex flex-col justify-between h-[calc(100%-0px)] bg-blue-50">
        ...
        <div className="px-1 py-2">
          <div className="flex w-full">
            <Link className="text-xl w-3/4 text-center text-blue-600" to={"/"}>
            ...
            <button
              ...
              className="rounded-full w-1/4 bg-rose-600 pr-3 items-center p-2 ml-3 text-center text-white hover:bg-rose-700 dark:bg-rose-500 dark:hover:bg-rose-600"
            >
              <MdAddCircleOutline className="w-8 h-6" />
            </button>
          </div>
          ...
          <nav aria-label="Main Nav" className="flex flex-col mt-5 space-y-1">
            <NavLink
              to={`github`}
              key={"github"}
              className="flex items-center px-4 py-2  hover:bg-orange-300 hover:text-black
              rounded-lg border mb-1"
            >
              <BsGithub />

              <span className="ml-3 text-sm font-medium">GitHub</span>
            </NavLink>
